...
class _CalibrationFormState extends State<CalibrationForm> {
          ...
          Row(
            children: [
              SizedBox(
                  ...
                  child: Text(
                      isAzimuth
                          ? S.of(context).azimuthRange
                          : S.of(context).elevationRange,
              ...
              SizedBox(
                  ...
                  child: Text(
                      isAzimuth
                          ? S.of(context).horizontalSpeed
                          : S.of(context).verticalSpeed,
                      style: Theme.of(context).textTheme.titleSmall)),
              const SizedBox(width: 10),
              SizedBox(
                  width: 100,
            ...
            children: [
              SizedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      child: Text(isAzimuth
                          ? S.of(context).horizontalReset
                          : S.of(context).verticalReset))),
              const SizedBox(width: 10),
              SizedBox(
                  width: 200,
                  child: ElevatedButton(
              ...
              SizedBox(
                  width: 200,
                  child: ElevatedButton(
                      onPressed: _onSave, child: Text(S.of(context).save))),
            ],
          )
        ],
      ),
  ...
  void _onResetFinish() {
    ...
    isAzimuth
        ? model.currentAzimuth = model.azimuthBegin.toDouble()
        : model.currentElevation = model.elevationBegin.toDouble();
  ...
  void _saveElevation(
      RotatorModel rotatorModel, int begin, int end, int speed) {
